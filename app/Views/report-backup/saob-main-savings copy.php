...
<div class="container-fluid">
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <div class="d-flex justify-content-center gap-2">
                                        <button class="btn btn-sm fs-6 text-secondary p-0 border-0 bg-transparent" 
                                                onclick="__mysys_saob_rpt_ent.__showPdfInModal('<?= base_url('mysaobrpt?meaction=SAVINGS-PRINT&program_title='.$program_title) ?>')" 
    ...
    <!-- SAVINGS ENTRY -->
    <?php if(!empty($recid)):?>
    <form action="<?=site_url();?>mysaobrpt?meaction=SAVINGS-SAVE" method="post" class="mysaob-savings-validation">
    <div class="row mb-2">
        <div class="col-sm-12">
            <div class="card">
                <div class="row mysaob-outp-savings-msg mx-0">
                ...
                <div class="card-header bg-primary p-1">
                    <div class="row">
                        <div class="col-sm-6 d-flex align-items-center text-start">
                            <h6 class="mb-0 lh-base px-3 text-white fw-semibold d-flex align-items-center">
                                <i class="ti ti-pencil fs-5 me-1"></i>
                                <span class="pt-1">Savings Entry</span>
                            </h6>
                        </div>
                    </div>
                </div>						
                <div class="card-body p-0 px-4 py-2 my-2">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-8">
                                    <label for="savings_date"><span class="">Savings Date</span></label>
                                    <input type="hidden" id="project_id" name="project_id" value="<?=$recid;?>" class="form-control form-control-sm"/>
                                    <input type="hidden" id="sprogram_title" name="sprogram_title" value="<?=$program_title;?>" class="form-control form-control-sm"/>
                                    <input type="month" id="savings_date" name="savings_date" value="<?=$savings_date;?>" class="form-control form-control-sm"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="table-responsive pe-2 ps-0">
                            <div class="col-md-12 mb-2">
                                <table id="savings_line_items" class="table-sm table-striped savingsdata-list">
                                    <thead>
                                        <th class="text-center">
                                            <a class="text-info px-2 fs-7 bg-hover-primary nav-icon-hover position-relative z-index-5" id="btn_trxjournalitem_add" href="javascript:__mysys_saob_rpt_ent.my_add_savings_line();"><i class="ti ti-new-section"></i></a>
                                        </th>
                                        <th class="text-center align-middle">Project Title</th>
                                        <th class="text-center align-middle">Responsibility Code</th>
                                        <th class="text-center align-middle">Project Leader</th>
                                        <th class="text-center align-middle">Declaired savings</th>
                                        <th class="text-center align-middle">Other Expenses Charged to Saving</th>
                                        <th class="text-center align-middle">CNA</th>
                                        <th class="text-center align-middle">Total Obligations</th>
                                        <th class="text-center align-middle">Balance of Savings</th>
                                    </thead>
                                    <tbody>
                                        <tr style="display:none;">
                                            <td class="text-center align-middle">
                                                <div class="d-inline-flex gap-1 justify-content-center">
                                                    ...
                                                    href="javascript:void(0)"
                                                    title="Add rows above"
                                                    onclick="__mysys_saob_rpt_ent.my_add_savings_line_above(this);">
                                                        <i class="ti ti-plus"></i>
                                                    </a>
                                                </div>
                                            </td>
                                            ...
                                            <td class="align-middle" nowrap>
                                                <input type="text" id="project_leader"  value="" size="35"  name="project_leader" class="project_leader text-center">
                                            </td>
                                            <td class="text-center align-middle" nowrap>
                                                <input type="number" id="declared_savings"  value="" size="25" step="any"  name="declared_savings"  class="declared_savings text-center"/>
                                            </td>
                                            <td class="text-center align-middle" nowrap>
                                                <input type="number" id="other_expenses"  value="" size="25" step="any" name="other_expenses"  class="other_expenses text-center"/>
                                            </td>
                                            <td class="text-center align-middle" nowrap>
                                                <input type="number" id="cna"  value="" size="25" step="any"  name="cna"  class="cna text-center"/>
                                            </td>
                                            <td class="text-center align-middle" nowrap>
                                                <input type="number" id="total_obligations"  value="" size="25" step="any" name="total_obligations" class="total_obligations text-center"/>
                                            </td>
                                            <td class="text-center align-middle" nowrap>
                                                <input type="number" id="balance_savings"  value="" size="25" step="any" name="balance_savings" class="balance_savings text-center"/>
                                            </td>
                                        </tr>
                                        <?php if(!empty($savings_date)):
                                            $query = $this->db->query("
                                            SELECT
                                                `recid`,
                                                `project_id`,
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle" nowrap>
                                                <input type="text" id="project_leader"  value="<?=$project_leader;?>" size="35"  name="project_leader" class="project_leader text-center">
                                            </td>
                                            <td class="text-center align-middle" nowrap>
                                                <input type="number" id="declared_savings"  value="<?=$declared_savings;?>" size="25" step="any"  name="declared_savings"  class="declared_savings text-center"/>
                                            </td>
                                            <td class="text-center align-middle" nowrap>
                                                <input type="number" id="other_expenses"  value="<?=$other_expenses;?>" size="25" step="any" name="other_expenses"  class="other_expenses text-center"/>
                                            </td>
                                            <td class="text-center align-middle" nowrap>
                                                <input type="number" id="cna"  value="<?=$cna;?>" size="25" step="any"  name="cna"  class="cna text-center"/>
                                            </td>
                                            <td class="text-center align-middle" nowrap>
                                                <input type="number" id="total_obligations"  value="<?=$total_obligations;?>" size="25" step="any" name="total_obligations" class="total_obligations text-center"/>
                                            </td>
                                            <td class="text-center align-middle" nowrap>
                                                <input type="number" id="balance_savings"  value="<?=$balance_savings;?>" size="25" step="any" name="balance_savings" class="balance_savings text-center"/>
                                            </td>
                                        </tr>
                                        <?php endforeach; endif;?>
                                    </tbody>
                    ...
                    <div class="row mb-2">  
                        <div class="col-sm-12 text-end">
                            <button type="submit" id="submitBtnSavings" class="btn bg-<?= empty($recid) ? 'success' : 'info' ?>-subtle text-<?= empty($recid) ? 'success' : 'info' ?> btn-sm"><i class="ti ti-brand-doctrine mt-1 fs-4 me-1"></i>
                                <?= empty($recid) ? 'Save' : 'Update' ?>
                            </button>
                        </div>
                    </div>
                ...
                <div class="card-header bg-primary p-1">
                    <div class="row">
                        <div class="col-sm-6 d-flex align-items-center text-start">
                            <h6 class="mb-0 lh-base px-3 text-white fw-semibold d-flex align-items-center">
                                <i class="ti ti-list fs-5 me-1"></i>
                                <span class="pt-1">Savings List</span>
                            </h6>
                        </div>
                    </div>
                </div>						
                <div class="card-body p-0 px-4 py-2 my-2">
                    <table id="tbl_savings" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>Action</th>
                                <th>Program Title</th>
                                <th>Declared Savings</th>
                                <th>Other Expenses</th>
                                <th>CNA</th>
                                <th>Total Obligations</th>
                                <th>Balance Savings</th>
                                <th>Date</th>
                                <th>Print Monthly Status</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if(!empty($savingsdata)):
                                foreach ($savingsdata as $data):
                                    $project_title = $data['project_title'];
                                    $responsibility_code = $data['responsibility_code'];
                                    $project_leader = $data['project_leader'];
                                    $declared_savings = $data['declared_savings'];
                                    ...
                                    $short_program = strlen($program_title) > 80
                                    ? substr($program_title, 0, 40) . '...'
                                    : $program_title;
                            ?>
                            <tr>
                                <td class="text-center align-middle">
                                    <a class="text-info nav-icon-hover" href="mysaobrpt?meaction=MAIN&recid=<?=$recid?>&savings_date=<?= $savings_date ?>" title="Edit Transaction">
                                        <i class="ti ti-edit"></i>
                                    </a>
                                </td>
                                <td class="text-center"><?=$short_program;?></td>
                                <td class="text-center"><?=$declared_savings;?></td>
                                <td class="text-center"><?=$other_expenses;?></td>
                                <td class="text-center"><?=$cna;?></td>
                                <td class="text-center"><?=$total_obligations;?></td>
                                <td class="text-center"><?=$balance_savings;?></td>
                                <td class="text-center"><?=$savings_date;?></td>
                                <td class="text-center align-middle">
                                    <div class="d-flex justify-content-center gap-2">
                                        <button class="btn btn-sm fs-6 text-warning p-0 border-0 bg-transparent" 
                                                onclick="__mysys_saob_rpt_ent.__showPdfInModal('<?= base_url('mysaobrpt?meaction=SAVINGS-PRINT&savings_date='.$savings_date.'&program_title='.$program_title) ?>')" 
                                                title="Print Monthly Status">
                                        <i class="ti ti-printer"></i>
                                        </button>
                                    </div>
...
<script>
    ...
    __mysys_saob_rpt_ent.__saob_savings_saving();
    __mysys_saob_rpt_ent.__combined_totals();
</script>
