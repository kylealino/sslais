...
$duration_from = "";
$duration_to = "";
$current_year = date('Y'); // default for new records
$program_leader = "";
$project_leader = "";
$monitoring_agency = "";
...
if(!empty($recid) || !is_null($recid)) { 
    ...
    $duration_from = !empty($data['duration_from']) ? $data['duration_from'] : $current_year . '-01-01';
...
// Default duration_from to current year (e.g. 2026-01-01) when empty (new record or missing in DB)
if (empty($duration_from)) {
    $duration_from = $current_year . '-01-01';
}
