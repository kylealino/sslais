...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2026 at 08:37 AM
...
(68, 12, 6, 2, '2026-04-24', 920417.45, 7670.15, 80245.74, 87915.89, 'unpaid', 840171.70, 'ADMIN-KYLE', '2026-03-24 07:33:12'),
...
(1, 12301293, 'KYLE ANDRAE', 'ALIÑO', 'POSADAS', '123 address hehe caloocan city', 912031023, 'kylealino@gmail.com', 'ADMIN-KYLE', '123456', 'ba3253876aed6bc22d4a6ff53d8406c6ad864195ed144ab5c87621b6c233b548baeae6956df346ec8c17f5ea10f35ee3cbc5', 'ADMIN-KYLE', '2026-03-22 10:00:14'),
...
--
ALTER TABLE `tbl_loans`
  MODIFY `loan_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tbl_loans_ammortization`
--
ALTER TABLE `tbl_loans_ammortization`
  MODIFY `ammortization_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;

--
-- AUTO_INCREMENT for table `tbl_loans_payment`
--
ALTER TABLE `tbl_loans_payment`
  MODIFY `payment_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbl_members`
--
ALTER TABLE `tbl_members`
  MODIFY `member_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
